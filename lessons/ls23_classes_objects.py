...
class Pizza:
    ...
    # The above is a new type (like bool, int...)
    ...
    # Below, a function that calculates the cost of a pizza based on its attributes
...
# Below, the func call Pizza() is a special type of func call known as a constructor call because Pizza is a class

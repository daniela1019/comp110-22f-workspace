...
def test_concat_diff_lens() -> None:
    """Tests function with 2 lists of different lengths."""
    xs: list[int] = [-1, 3, 6, 0]
    ys: list[int] = [4, 5, 9]
...
def test_concat_empty_lists() -> None:
    """Tests function with 2 empty lists."""
    xs: list[int] = []
    ys: list[int] = []
    assert concat(xs, ys) == []
...
def test_sub_norm_indices_1() -> None:
    """Tests function with a long-ish list."""
...
def test_sub_norm_indices_2() -> None:
    """Tests function with another longer list."""
...
def test_sub_large_start() -> None:
    """Tests function when start exceeds list length."""
